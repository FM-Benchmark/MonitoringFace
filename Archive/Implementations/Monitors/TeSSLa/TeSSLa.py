...
# Phase 0 (always): "<tp>: mf_v = <bool>".
# Phase 1 (open formulas): "0: mf_cols = x1,x2" once, "<tp>: mf_ts = <ts>" per
# timepoint, and "<tp>: mf_set = Set(List(..), ..)" exactly at satisfying
# timepoints (the JVM prints large sets as "HashSet(..)").
